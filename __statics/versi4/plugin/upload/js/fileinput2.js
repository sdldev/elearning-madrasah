...
(function (factory) {
        ...
        _initTemplateDefaults: function () {
            ...
            self.defaults = {
                ...
                fileActionSettings: {
                    ...
                    showZoom: true,
                    showDrag: false,
                    removeIcon: '<i class="fa fa-trashs"></i>',
    ...
    $.fn.fileinputLocales.en = {
        ...
        msgUploadEmpty: 'Tidak ada file yang diupload.',
        ...
        msgDuplicateFile: 'File "{name}" Ukuran  "{size} KB" sudah dipilih, rename nama file terlebih dahulu.',
