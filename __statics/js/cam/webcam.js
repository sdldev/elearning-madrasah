...
window.webcam = {
	...
	swf_url: base_url+'__statics/js/cam/webcam.swf', // URI to webcam.swf movie (defaults to cwd)
	shutter_url: base_url+'__statics/js/cam/shutter.mp3', // URI to shutter.mp3 sound
	...
	set_shutter_sound: function(enabled, url) {
		...
		this.shutter_url = url ? url : base_url+'__statics/js/cam/shutter.mp3';
	},
