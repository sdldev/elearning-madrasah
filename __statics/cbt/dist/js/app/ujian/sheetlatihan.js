...
function selesai() {
    ...
    $.ajax({
        ...
        success: function (r) {
            ...
            if (r.status) {
                window.location.href = base_url + 'cbt/token/'+r.nama+'/'+r.id+'/'+r.token;
            }
        }
    });
}
...
function simpan_akhir() {
   // simpan();   
				Swal.fire({
			  title: 'Apakah Anda yakin menyelesaikan Latihan Topik ini ?',
			  text: "Anda akan dikembalikan kedalam Guru Berbagi !",
			  type: 'warning',
			  showCancelButton: true,
			  confirmButtonColor: '#3085d6',
			  cancelButtonColor: '#d33',
			  confirmButtonText: 'Ya, Akhiri Latihan ini ',
			  ...
			  if (result.value) {
				   ...
				   Swal.fire(
				  'Terimakasih !',
				  'Anda sudah mengakhiri latihan ini ',
				  'success'
				)
