...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tImage = '<iframe src="{data}" class="kv-preview-data file-preview-office" title="{title}" ' +
                'alt="{alt}"' + tStyle + '></iframe>\n';
    ...
    $.fn.fileinput.defaults = {
        ...
        previewZoomButtonIcons: {
            ...
            toggleheader: '<i class="fa fa-window-restore"></i>',
            fullscreen: '<i class="fa fa-arrow"></i>',
        ...
        cancelIcon: '<i class="fa fa-times"></i>',
    ...
    $.fn.fileinputLocales.en = {
        ...
        msgAjaxError: 'Browser Anda mengalami masalah, Kami merekomendasikan menggunakan Google Chrome untuk Platform Madrasah Berbagi',
        ...
        dropZoneTitle: 'Letakan File Anda disini ',
